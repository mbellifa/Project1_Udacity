...
<head>
    ...
    <script type="text/javascript" charset="utf-8">
        //Shuffles the given array and returns a new one
        ...
        //I split this out from document.ready so I could reanimate after shuffling
        function movieTileAnimation() {
        ...
        $(document).on('click','#random',function (e) {
            e.preventDefault();
            //This now contains a list of all the movie divs
            var movies = $('.movies').children('div').detach();
            $('.movies').append(shuffle(movies));
            movieTileAnimation();
...
def open_movies_page(movies):
    ...
    # Output the file
    total_content = main_page_head + rendered_content
